...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex align-items-center">
                    <i class="d-lg-none fa fa-align-justify fs-24 pr-3 opacity-80" onclick="categoryhover()"></i>
                ...
                <div class="d-none d-lg-block  align-self-stretch ml-3 mr-0 pt-3 pl-5">
                    <div class="text-right fw-600" >
                        <div>
                        Support (+880)1321377...
                    </div>
                    <div>
                        Email: contact@webearth.com
                    </div>
                    </div>
                </div>
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="bg-white  py-1 " style="border-bottom: 2px solid #00b4d8;">
            <div class="container d-none d-lg-block">
                <div class="row">
                    <div class="col-3 py-1 " id="category-menu-icon">
                      <span class="border fw-600 bg-white hov-bg-primary px-2 py-2 hov-text-white text-center ">  <li class="list-inline-item pr-4 w-100" id="category-menu-icon" ><i class="fa fa-tv fs-22 pr-2"></i>All Categories <i class="fa fa-caret-down pl-2"></i></li></span> 
                    </div>
                    <div class="col-6">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    @foreach (json_decode( get_setting('header_menu_labels'), true) as $key => $value)
                    <li class="list-inline-item mr-0">
                    <span class="border bg-white hov-bg-primary px-2 py-2 hov-text-white"> <a href="{{ json_decode( get_setting('header_menu_links'), true)[$key] }}" class="fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            {{ translate($value) }}
                        </a>
                    </span>
                    </li>
    ...
    @endif
       ...
       @if(Route::currentRouteName() != 'home')
        <div class="hover-category-menu position-absolute w-100 top-100 left-0 right-0 d-none z-3" style="margin-top: -10px;" id="hover-category-menu">
            <div class="container">
        ...
        @endif
@if(Route::currentRouteName() == 'home')
        <div class="d-lg-none hover-category-menu position-absolute w-100 top-100 left-0 right-0 d-none z-3" style="margin-top: -10px;" id="hover-category-menu">
            <div class="container">
                <div class="row gutters-10 position-relative">
                    <div class="col-lg-3 position-static">
                        @include('frontend.partials.category_menu')
