            ...
            <ul class="aiz-side-nav-list  ">
                <li class="aiz-side-nav-item ">
                    <a href="{{ route('dashboard') }}" class="aiz-side-nav-link {{ areActiveRoutes(['dashboard'])}}">
                       <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-home user-panel-icon  user-panel-icon aiz-side-nav-icon"></i></span>
                        <span class=" aiz-side-nav-text text-black">{{ translate('Dashboard') }}</span>
                    </a>
                </li>
                ...
                @if(Auth::user()->user_type == 'delivery_boy')
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('assigned-deliveries') }}" class="aiz-side-nav-link {{ areActiveRoutes(['completed-delivery'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-hourglass-half user-panel-icon  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">
                    ...
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('pickup-deliveries') }}" class="aiz-side-nav-link {{ areActiveRoutes(['completed-delivery'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-luggage-cart  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">
                    ...
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('on-the-way-deliveries') }}" class="aiz-side-nav-link {{ areActiveRoutes(['completed-delivery'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-running  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">
                    ...
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('completed-deliveries') }}" class="aiz-side-nav-link {{ areActiveRoutes(['completed-delivery'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-check-circle  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">
                    ...
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('pending-deliveries') }}" class="aiz-side-nav-link {{ areActiveRoutes(['pending-delivery'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-clock  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">
                    ...
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('cancelled-deliveries') }}" class="aiz-side-nav-link {{ areActiveRoutes(['cancelled-delivery'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-times-circle  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">
                    ...
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('total-collection') }}" class="aiz-side-nav-link {{ areActiveRoutes(['today-collection'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-comment-dollar  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">
                ...
                @else
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('purchase_history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['purchase_history.index'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-file-alt user-panel-icon  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">{{ translate('Purchase History') }}</span>
                    ...
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('digital_purchase_history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['digital_purchase_history.index'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-download  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">{{ translate('Downloads') }}</span>
                        </a>
                    </li>
                    ...
                    @if (addon_is_activated('refund_request'))
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('customer_refund_request') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_refund_request'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-backward  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Sent Refund Request') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('wishlists.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['wishlists.index'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="la la-heart-o  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">{{ translate('Wishlist') }}</span>
                        </a>
                    </li>

                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('compare') }}" class="aiz-side-nav-link {{ areActiveRoutes(['compare'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="la la-refresh  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">{{ translate('Compare') }}</span>
                        </a>
                    </li>
                    ...
                    @if(Auth::user()->user_type == 'seller')
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('seller.products') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.products', 'seller.products.upload', 'seller.products.edit'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="lab la-sketch  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Products') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item ">
                            <a href="{{route('product_bulk_upload.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['product_bulk_upload.index'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-upload  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Product Bulk Upload') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('seller.digitalproducts') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.digitalproducts', 'seller.digitalproducts.upload', 'seller.digitalproducts.edit'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="lab la-sketch  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Digital Products') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('my_uploads.all') }}" class="aiz-side-nav-link {{ areActiveRoutes(['my_uploads.new'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-folder-open  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Uploaded Files') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('seller.coupon.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['my_uploads.new'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-bullhorn  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Coupon') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if(get_setting('classified_product') == 1)
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('customer_products.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_products.index', 'customer_products.create', 'customer_products.edit'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="lab la-sketch  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Classified Products') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if(addon_is_activated('auction'))
                        <li class="aiz-side-nav-item ">
                            <a href="javascript:void(0);" class="aiz-side-nav-link">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-gavel  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Auction') }}</span>
                                ...
                                @if (Auth::user()->user_type == 'seller')
                                    <li class="aiz-side-nav-item ">
                                        <a href="{{ route('auction_products.seller.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['auction_products.seller.index','auction_products.create','auction_products.edit'])}}">
                                            <span class=" aiz-side-nav-text text-black">{{ translate('All Auction Products') }}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item ">
                                        <a href="{{ route('auction_products_orders.seller') }}" class="aiz-side-nav-link {{ areActiveRoutes(['auction_products_orders.seller'])}}">
                                            <span class=" aiz-side-nav-text text-black">{{ translate('Auction Product Orders') }}</span>
                                        </a>
                                    </li>
                                @endif
                                <li class="aiz-side-nav-item ">
                                    <a href="{{ route('auction_product_bids.index') }}" class="aiz-side-nav-link">
                                        <span class=" aiz-side-nav-text text-black">{{ translate('Bidded Products') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item ">
                    ...
                    @if(Auth::user()->user_type == 'seller')
                            ...
                            @if (\App\Models\BusinessSetting::where('type', 'pos_activation_for_seller')->first() != null && get_setting('pos_activation_for_seller') != 0)
                                <li class="aiz-side-nav-item ">
                                    <a href="{{ route('poin-of-sales.seller_index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['poin-of-sales.seller_index'])}}">
                                        <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-fax  user-panel-icon aiz-side-nav-icon"></i></span>
                                        <span class=" aiz-side-nav-text text-black">{{ translate('POS Manager') }}</span>
                                    </a>
                                </li>
                            @endif
                        @endif
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['orders.index'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-money-bill  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Orders') }}</span>
                            </a>
                        </li>
                        ...
                        @if (addon_is_activated('refund_request'))
                            <li class="aiz-side-nav-item ">
                                <a href="{{ route('vendor_refund_request') }}" class="aiz-side-nav-link {{ areActiveRoutes(['vendor_refund_request','reason_show'])}}">
                                    <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-backward  user-panel-icon aiz-side-nav-icon"></i></span>
                                    <span class=" aiz-side-nav-text text-black">{{ translate('Received Refund Request') }}</span>
                                </a>
                            </li>
                        @endif
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('reviews.seller') }}" class="aiz-side-nav-link {{ areActiveRoutes(['reviews.seller'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-star-half-alt  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Product Reviews') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('shops.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['shops.index'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-cog  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Shop Setting') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('payments.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['payments.index'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-history  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Payment History') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('withdraw_requests.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['withdraw_requests.index'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-money-bill-wave-alt  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Money Withdraw') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('commission-log.index') }}" class="aiz-side-nav-link">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-file-alt  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Commission History') }}</span>
                            </a>
                        </li>
                    ...
                    @if (get_setting('conversation_system') == 1)
                        ...
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('conversations.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['conversations.index', 'conversations.show'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-comment  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Conversations') }}</span>
                    ...
                    @if (get_setting('wallet_system') == 1)
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('wallet.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['wallet.index'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-dollar-sign  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{translate('My Wallet')}}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (addon_is_activated('club_point'))
                        <li class="aiz-side-nav-item ">
                            <a href="{{ route('earnng_point_for_user') }}" class="aiz-side-nav-link {{ areActiveRoutes(['earnng_point_for_user'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-dollar-sign  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{translate('Earning Points')}}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (addon_is_activated('affiliate_system') && Auth::user()->affiliate_user != null && Auth::user()->affiliate_user->status)
                        <li class="aiz-side-nav-item ">
                            <a href="javascript:void(0);" class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.user.index', 'affiliate.payment_settings'])}}">
                                <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-dollar-sign  user-panel-icon aiz-side-nav-icon"></i></span>
                                <span class=" aiz-side-nav-text text-black">{{ translate('Affiliate') }}</span>
                                <span class="aiz-side-nav-arrow"></span>
                            </a>
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item ">
                                    <a href="{{ route('affiliate.user.index') }}" class="aiz-side-nav-link">
                                        <span class=" aiz-side-nav-text text-black">{{ translate('Affiliate System') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item ">
                                ...
                                <li class="aiz-side-nav-item ">
                                    <a href="{{ route('affiliate.user.withdraw_request_history') }}" class="aiz-side-nav-link">
                                        <span class=" aiz-side-nav-text text-black">{{ translate('Withdraw request history') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('support_ticket.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['support_ticket.index'])}}">
                            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-atom  user-panel-icon aiz-side-nav-icon"></i></span>
                            <span class=" aiz-side-nav-text text-black">{{translate('Support Ticket')}}</span>
                ...
                <li class="aiz-side-nav-item ">
                    <a href="{{ route('profile') }}" class="aiz-side-nav-link {{ areActiveRoutes(['profile'])}}">
                        <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-user  user-panel-icon aiz-side-nav-icon"></i></span>
                        <span class=" aiz-side-nav-text text-black">{{translate('Manage Profile')}}</span>
                    </a>
                </li>
				<li class="aiz-side-nav-item ">
				 <a class="aiz-side-nav-link" href="{{ route('logout') }}">
            <span class="user-panel-icon-bg bg-soft-dark mr-3" ><i class="las la-sign-out-alt  user-panel-icon aiz-side-nav-icon fs-18 mr-2"></i></span>
					 <span class=" aiz-side-nav-text text-black">{{ translate('Logout') }}</span> 
        </a>
</li>
            </ul>
