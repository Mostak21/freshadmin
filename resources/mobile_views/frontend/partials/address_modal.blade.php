                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Your Full Name')}}" name="name" required>
                            </div>
                        </div>
                        @endif
...
@section('script')
    <script type="text/javascript">
        ...
        function get_city(state_id) {
            $('[name="city"]').html("");
            if (state_id == 348) {
                $(".bs-searchbox").addClass("d-none");
            }
            else {
                $(".bs-searchbox").removeClass("d-none");
            }
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
