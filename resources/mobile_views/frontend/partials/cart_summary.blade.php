<div class="card rounded " style="">
   {{-- <div class="card-header">
    ...
    <div class="card-body">
        ...
        @php
                ...
                @foreach ($carts as $key => $cartItem)
                    ...
                    @endphp
                    <div class="row p-2 align-items-center product-fullwidth">
                        <div class="col-3 p-0">
                            <a class="" href=""> <img src="{{ uploaded_asset($product->thumbnail_img) }}" alt="{{ $product_name_with_choice }}" class="mr-2 p-img-round"></a>
                ...
                @endforeach
                      <div class="fs-14 fw-600 p-2 mt-5">
    ...
    <h3 class="text-center">{{ single_price($total) }}</h3>
            ...
            @else
                <div class="mt-3">
                    <form class="" id="apply-coupon-form" enctype="multipart/form-data">
                        ...
                        <div class="w-100 pt-2">
                            <button type="button" style ="width: 100%" id="coupon-apply" class="btn btn-outline-dark btn-soft-dark fw-600">{{translate('Apply Coupon Code')}}</button>
                        </div>
                    </form>
                </div>
            @endif
