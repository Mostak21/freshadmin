                            ...
                            <tr>
							 ...
							 @if ($order->payment_status == 'partial_paid' || $order->payment_status == 'delivery_paid')
                                <tr class="border-bottom">
                                    <td> <strong class="w-50 fw-600">{{translate('Partial Paid')}} :</strong> </td>
                                    <td class="text-right">
                                        {{ single_price($order->partial_pay) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td> <strong class="w-50 fw-600">{{translate('Due')}} :</strong> </td>
                                    <td class="text-right">
                                        <strong><span>{{ single_price($order->grand_total - $order->partial_pay) }}</span></strong>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
