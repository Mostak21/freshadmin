@php
    //include ('../views/backend/invoices/invoice.blade.php');
    include ($_SERVER['DOCUMENT_ROOT'].'/httpdocs/resources/views/backend/invoices/invoice.blade.php');
...
{{--                          <tr class="border-bottom">--}}
{{--                              <th class="gry-color text-left ">{{ translate('Paid Amount') }}</th>--}}
{{--                              <td class="currency">{{ single_price($order->grand_total) }}</td>--}}
{{--                          </tr>--}}
{{--                          <tr>--}}
...
{{--                            <tr class="border-bottom">--}}
{{--                                <th class="gry-color text-left ">{{ translate('Paid Amount') }}</th>--}}
{{--                                <td class="currency">{{ single_price(0.00) }}</td>--}}
{{--                            </tr>--}}
{{--                            <tr>--}}
{{--                                <th class="text-left strong"><b>{{ translate('Due') }}</b></th>--}}
{{--                                <td class="currency"><b>{{ single_price($order->grand_total) }}</b></td>--}}
{{--                            </tr>--}}
{{--                      @endif--}}
{{--						        </tbody>--}}
{{--						    </table>--}}
