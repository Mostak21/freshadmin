		...
		<div class="modal-content h-100">
			<div class="modal-header pb-0 bg-light">
				<div class="uppy-modal-nav">
					<ul class="nav nav-tabs border-0">
						<li class="nav-item">
							<a class="nav-link active font-weight-medium text-dark" data-toggle="tab" href="#rit-select-file">{{ translate('Select File') }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link font-weight-medium text-dark" data-toggle="tab" href="#rit-upload-new">{{ translate('Upload New') }}</a>
						</li>
					</ul>
				</div>
							...
							<div class="row align-items-center gutters-5 gutters-md-10 position-relative">
								...
								<div class="col-md-4 col-xl-3 ml-auto mr-0 col-2 position-static">
									<div class="rit-uploader-search text-right">
										<input type="text" class="form-control form-control-xs" name="rit-uploader-search" placeholder="{{ translate('Search your files') }}">
			...
			<div class="modal-footer justify-content-between bg-light">
				<div class="flex-grow-1 overflow-hidden d-flex">
					<div class="">
						<div class="rit-uploader-selected">{{ translate('0 File selected') }}</div>
						<button type="button" class="btn-link btn btn-sm p-0 rit-uploader-selected-clear">{{ translate('Clear') }}</button>
					</div>
					<div class="mb-0 ml-3">
