        ...
        <div class="card-body">
            <form action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select name="gender" id="gender" class="form-control" required>
                            <option value="NULL"   @if( Auth::user()->gender == "NULL" )selected @endif hidden>Select your Gender</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" placeholder="{{ translate('Your Phone')}}" name="phone" value="{{ Auth::user()->phone }}" disabled>
                    </div>
                </div>
                <div class="form-group row">
