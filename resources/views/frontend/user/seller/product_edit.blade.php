            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control rit-tag-input" name="tags[]" id="tags"
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select class="form-control rit-selectpicker" data-live-search="true"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select name="choice_attributes[]" data-live-search="true" data-selected-text-format="count"
                        id="choice_attributes" class="form-control rit-selectpicker" multiple
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" class="form-control rit-date-range" value="{{ $start_date.' to '.$end_date }}" name="date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <textarea class="rit-text-editor"
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <input maxlength="60" id="TextBox1" type="text" class="form-control" name="meta_title" value="{{ $product->meta_title }}"
                        placeholder="{{translate('Meta Title within 47 character')}}">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-3 col-from-label">{{translate('Description')}}</label>
                <div class="col-lg-8">
                    <textarea id="TextBox2" maxlength="160" name="meta_description" rows="8"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#TextBox1").MaxLength({ MaxLength: 60 });
        $("#TextBox2").MaxLength({ MaxLength: 161 });
    });
    $(document).ready(function(){
