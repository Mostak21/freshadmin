    ...
    <div class="row ">
        <div class="col-md-5 round-2 productheaderbg">
            <div class="px-3 py-4 mparent" style="height: 100%;">
                ...
                <div><a class="text-primary" href="/category/womens-fashion">Shop for women <i class="ci-arrow-right fs-xs align-middle ms-1"></i></a></div>
                <div class="mchild">
 ...
 {{-- Banner section 2--}}
    ...
    <div class="row mt-lg-5 mt-3">
        ...
        <div class=" col-md-7 order-2 order-lg-1 pr-lg-4  prl-sm-0" >
            ...
            <div class="aiz-carousel dots-inside-bottom" style="overflow: visible;" data-arrows="true" data-dots="false" data-autoplay="true">
                @foreach ($mensproducts->chunk(6) as $key => $chunk)
        ...
        <div class="col-md-5 order-1 order-lg-2 round-2 productheaderbg">
            <div class="px-3 py-4 mparent text-right" style="height: 100%;">
                <h3 class="fw-600">For Men</h3>
                <div><a class="text-primary" href="/category/mens-fashion">Shop for Men<i class="ci-arrow-right fs-xs align-middle ms-1"></i></a></div>
                <div class="mchild">


                    <a class="d-none d-md-block mt-auto" href="shop-grid-ls.html"><img class="d-block w-100"
                                                                                       src="https://brandhook.s3.ap-south-1.amazonaws.com/uploads/all/7VgwGbIOB2iw5Uv72pMAXPq6uh0EmTizXKYJf2QD.webp" alt="For Men"></a>
                </div>
            </div>
        </div>
    </div><br><br>
...
<div class="container pb-3 px-5">
    ...
    <div class="row mt-lg-5 mt-3">
        <div class="col-md-5 round-2 productheaderbg">
            <div class="px-3 py-4 mparent" style="height: 100%;">
                <h3 class="fw-600">For Girls/Boys</h3>
                <div><a class="text-primary" href="/category/boys-fashion">Shop for Girls/Boys <i class="ci-arrow-right fs-xs align-middle ms-1"></i></a></div>
                <div class="mchild">


                    <a class="d-none d-md-block mt-auto" href="shop-grid-ls.html"><img class="d-block w-100"
                                                                                       src="https://brandhook.s3.ap-south-1.amazonaws.com/uploads/all/oSKAXhnqQFuasxv2a5e8cXySvSXqwZxHwRWfweyD.webp" alt="For Women"></a>
                </div>
            </div>
        </div>
        <div class="col-md-7 pl-lg-4" >
