    ...
    <div class="container">
        <div class="py-4 px-md-4 py-md-3 bg-white">
            <div class="">
                <div class="mb-3 mb-lg-0">
                    <a href="" class="d-block text-reset mb-3 rounded" >
                        <img src="https://brandhook.s3.ap-south-1.amazonaws.com/uploads/all/Ho7l0UGM5685NIULFCvAOZ2psHmGYeTV4iIFbFyF.webp" alt="{{ env('APP_NAME') }} promo" class="w-100 rounded img-fluid">
                    </a>
                </div>
            </div>
