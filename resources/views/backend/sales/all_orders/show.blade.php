...
{{--                @endif--}}
            ...
            <div class="col-md-3 ml-auto">
                ...
                <div class="pb-4">
                    ...
                    <select class="form-control aiz-selectpicker"  data-minimum-results-for-search="Infinity" id="update_shipping_status">
                        ...
                        <option value="on_hold" @if ($shipping_status == 'on_hold') selected @endif>{{translate('On Hold')}}</option>
                ...
                <table class="table table-bordered aiz-table invoice-summary">
                    <thead>
                        <tr class="bg-trans-dark">
                            ...
                            <th data-breakpoints="lg" class="text-uppercase">{{ translate('Vendor') }}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="fw-600">Name: </span>@if(!is_null($order->seller)) {{ $order->seller->name }}@else BRAND HOOK @endif<br>
                                 <span class="fw-600">Distributor :@if ($orderDetail->product != null) </span> {{$orderDetail->product->distributor}} @endif<br>
                                <span class="fw-600">DP : @if ($orderDetail->product != null) </span> {{$orderDetail->product->distributor_price}} @endif<br>
                            </td>
                            <td>
                                @if ($orderDetail->shipping_type != null && $orderDetail->shipping_type == 'home_delivery')
                                {{ translate('Home Delivery') }}
                                @elseif ($orderDetail->shipping_type == 'delivery_agent')
                                  {{ translate('Delivery Agent: ') }} {{$orderDetail->shipping_method??''}}
        ...
        <div class="clearfix float-right">
            ...
            <div class="text-right no-print">
				                <a href="{{ route('p_order.download', $order->id) }}" type="button" class="btn btn-icon btn-primary"><i class="las la-print"></i></a>
