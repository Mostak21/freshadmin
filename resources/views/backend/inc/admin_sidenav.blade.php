            ...
            <ul class="rit-side-nav-list" id="main-menu" data-toggle="rit-side-menu">
                ...
                @if (addon_is_activated('pos_system'))
                    @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="rit-side-nav-item">
                            <a href="{{route('poin-of-sales.index')}}" class="rit-side-nav-link">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('22', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="rit-side-nav-item">
                        <a href="#" class="rit-side-nav-link">
                            ...
                            <span class="rit-side-nav-text">{{ translate('Media and Files') }}</span>
                            <span class="rit-side-nav-arrow"></span>
                        </a>
                        <ul class="rit-side-nav-list level-2">
                            <li class="rit-side-nav-item">
...
{{--                contest menu--}}
                @if(Auth::user()->user_type == 'admin')
                    <li class="rit-side-nav-item">
                        <a href="#" class="rit-side-nav-link">
                            <i class="las la-trophy rit-side-nav-icon" style="color: green"></i>
                            <span class="rit-side-nav-text">{{ translate('FIFA Contest Campaign') }}</span>
                            <span class="rit-side-nav-arrow"></span>
                        </a>
                        <ul class="rit-side-nav-list level-2">
                            <li class="rit-side-nav-item">
                                <a href="{{route('contest.list')}}" class="rit-side-nav-link">
                                    <span class="rit-side-nav-text">{{ translate('Contest List') }}</span>
                                </a>
                            </li>
                            <li class="rit-side-nav-item">
                                <a href="{{route('contest.leaderboards')}}" class="rit-side-nav-link">
                                    <span class="rit-side-nav-text">{{ translate('Contest Lraderboards') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
