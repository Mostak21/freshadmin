                ...
                @if(Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('sitemapview') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">Sitemap Generator</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                ...
                                <ul class="aiz-side-nav-list level-3">
                                    ...
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('agents.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['agents.index','agents.edit','agents.update'])}}">
                                            <span class="aiz-side-nav-text">{{translate('Shipping Agents')}}</span>
                                        </a>
                                    </li>
