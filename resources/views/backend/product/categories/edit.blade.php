            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select name="digital" required class="form-control rit-selectpicker mb-2 mb-md-0">
                    ...
                    <div class="form-group row">
					 ...
					 <div class="form-group row">
                        <label class="col-md-3 col-form-label">Google Category ID</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="g_cat" value="{{ $category->g_cat }}" placeholder="Google Category ID">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">FB Category ID</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="f_cat" value="{{ $category->f_cat }}" placeholder="Facebook Category ID">
                        </div>
                    </div>
                    <div class="form-group row">
					...
					<div class="form-group row">
                        <label class="col-md-3 col-form-label">Auto Product Description</label>
                        <div class="col-md-9">
                            <textarea name="auto_description" rows="5" class="form-control">{{ $category->auto_description }}</textarea>
                        </div>
                    </div>


                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">Auto Category Description</label>
                        <div class="col-md-9">
                            <textarea name="auto_cat_description" rows="5" class="form-control">{{ $category->auto_cat_description }}</textarea>
                        </div>
                    </div>
					
					<div class="form-group row">
                        <label class="col-md-3 col-form-label" for="signinSrEmail"> Mobile cat background <small>(1000*150)</small></label>
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="m_bg" class="selected-files" value="{{ $category->m_bg }}">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
					...
					<div class="form-group row">
                        <label class="col-md-3 col-form-label" for="signinSrEmail"> Mobile cat image <small></small></label>
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="m_image" class="selected-files" value="{{ $category->m_image }}">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
					 ...
					 <div class="form-group row">
                        <label class="col-md-3 col-form-label">Mobile Cat Color</label>
                        <div class="col-md-9">
                            <input type="text" placeholder="Color"  name="m_color" value="{{ $category->m_color}}" class="form-control">
                        </div>
                    </div>
					<div class="form-group row">
                        <label class="col-md-3 col-form-label">Mobile Cat slogan</label>
                        <div class="col-md-9">
                            <input type="text" placeholder="slogan"  name="m_slogan" value="{{ $category->m_slogan}}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="select2 form-control rit-selectpicker" name="filtering_attributes[]" data-toggle="select2" data-placeholder="Choose ..."data-live-search="true" data-selected="{{ $category->attributes->pluck('id') }}" multiple>
