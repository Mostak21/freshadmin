			...
			<div class="card-body">
				<form action="{{ route('brands.store') }}" method="POST">
					...
					<div class="form-group mb-3">
						...
						<div>
							<input type="checkbox" name="category[]" value="fragnance"> Fragnance
						</div>
						<div>
							<input type="checkbox" name="category[]" value="Beauty_&_Skincare"> Beauty & Skincare
						</div>
						<div>
					...
					<div class="form-group mb-3">
						<label for="name">{{translate('Category')}}</label><br>
						<span class="pr-2">
							<input type="radio" name="published" value="1" checked> Show
						</span>
						<span>
							<input type="radio" name="published" value="0"> Hide
						</span>
