                                        ...
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    @if(isset($array['otp']) && is_numeric($array['otp']))
                                                    <tr>
                                                        <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:40px; font-weight: 600; line-height:26px; text-align:center; color:#be1e2d; padding-bottom:30px;">OTP: {{ $array['otp'] }} </td>
                                                    </tr>
                                                    @endif
                                                    <tr>
