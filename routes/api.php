...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    ...
    Route::get('dropdowncategories', 'Api\V2\CategoryController@dropdowncategories');
	...
	Route::get('womensproducts','Api\V2\ProductController@womensproducts');
    ...
    Route::post('profile/delete-account/{id}', 'Api\V2\UserController@delete_account')->middleware('auth:api');
