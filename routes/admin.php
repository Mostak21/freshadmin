...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/contest/leaderboards/', 'ContestController@adminleaderboards')->name('contest.leaderboards');


    Route::get('/sitemapbh', 'AdminController@sitemap')->name('sitemapbh');
    Route::get('/sitemap', function(){
            return view('backend.website_settings.sitemap');

    })->name('sitemapview');


    //custom controller of Brandhook developer

    Route::get('/note','AdminController@notemodal')->name('addnote');
    Route::get('/notestore','AdminController@notestore')->name('note.store');
...
//    Route::get('/seller_orders/{id}/show', 'OrderController@seller_orders_show')->name('seller_orders.show');
    ...
    Route::resource('agents', 'DeliveryAgentController');
    Route::get('/agents/edit/{id}', 'DeliveryAgentController@edit')->name('agents.edit');
    Route::get('/agents/destroy/{id}', 'DeliveryAgentController@destroy')->name('agents.destroy');
    Route::post('/agents/status', 'DeliveryAgentController@updateStatus')->name('agents.status');

    Route::resource('deliverycost', 'DeliveryCostController');
    Route::get('/deliverycost/save/{id}', 'DeliveryCostController@save')->name('deliverycost.save');
    Route::post('/deliverycost/status', 'DeliveryCostController@updateStatus')->name('deliverycost.status');
	...
	Route::get('/bulkdestroy', 'AizUploadController@bulkdestroy')->name('uploaded-files.bulkdestroy');
    Route::get('/bulk-delete', 'AizUploadController@bulkdelete')->name('uploaded-files.bulkdelete');
