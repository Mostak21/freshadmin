...
Route::post('/select-team', 'ContestController@selectTeam')->name('select.team');
...
Route::post('/users/login/guest', 'HomeController@cart_login_guest')->name('cart.login.guest');
...
Route::get('/robots.txt', function() {
    return base_path('robots.txt');
});
Route::get('/serviceworker.js', function() {
    return base_path('serviceworker.js');
})->name('serviceworker');
...
Route::group(['middleware' => ['auth']], function() {
	...
	Route::get('purchaseorder/{order_id}', 'InvoiceController@p_order_download')->name('p_order.download');
    ...
    Route::post('/orders/staff-assign', 'OrderController@assign_staff')->name('orders.staff-assign');
	...
	Route::get('/product-bulk-export-facebook', 'ProductBulkUploadController@export_facebook')->name('product_bulk_export_facebook.index');
    ...
    Route::get('/product-bulk-export-single-brand', 'ProductBulkUploadController@export_single_brand')->name('product_bulk_export.single_brand');
	    Route::get('/product-bulk-export-single-brand-fb', 'ProductBulkUploadController@export_single_brand_fb')->name('product_bulk_export.single_brand_fb');
...
Route::get('/blog/category/{cat}', 'BlogController@blog_category')->name('blog.category');
