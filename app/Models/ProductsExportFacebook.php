...
class ProductsExportFacebook implements FromCollection, WithMapping, WithHeadings
{
    ...
    */
    public function map($product): array
    {
		...
		if(!empty($product->category->name)){$product_category_name=$product->category->name;}
		else{$product_category_name="NULL";}
