...
class AddressController extends Controller
{
    ...
    {
        if(strlen($request->phone)==14 && strpos($request->phone,"+8801")==0 && is_numeric($request->phone)){
            $user_phone = $request->phone;
        }
        elseif (strlen($request->phone)==11 && strpos($request->phone,"01")==0  && is_numeric($request->phone)){
            $user_phone = '+88'.$request->phone;
        }
        else{
            flash(translate('Please enter a valid phone number'))->error();
