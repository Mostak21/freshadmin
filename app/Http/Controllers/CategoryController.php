...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$category->f_cat=$request->f_cat;
        $category->g_cat=$request->g_cat;
        $category->meta_title = $request->meta_title;
        $category->meta_description = $request->meta_description;
		$category->auto_description = $request->auto_description;
        $category->auto_cat_description = $request->auto_cat_description;
    ...
    public function update(Request $request, $id)
    {
		...
		$category->auto_description = $request->auto_description;
        $category->auto_cat_description = $request->auto_cat_description;
		$category->m_image=$request->m_image;
		$category->m_bg=$request->m_bg;
		$category->m_color=$request->m_color;
		$category->m_slogan=$request->m_slogan;
